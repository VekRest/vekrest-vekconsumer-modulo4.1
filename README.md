...
| VekConsumer    | Consumer - Consumer Kafka simples    | Este Repositório                                                                                    
...
> A imagem desta aplicação é atualizada a cada nova tag ou pull request na [branch main](https://github.com/VekRest/vekrest-vekconsumer-modulo4.1/tree/main)

> Link da imagem no DockerHub: [vek03/vekrest-vekconsumer:latest](https://hub.docker.com/r/vek03/vekrest-vekconsumer)
...
```bash
docker pull vek03/vekrest-vekconsumer:latest
```
...
docker run -d \
  ...
  vek03/vekrest-vekconsumer:latest
```
...
services:
  vekconsumer:
    image: vek03/vekrest-vekconsumer:latest
...
```bash
# Clonar
git clone https://github.com/VekRest/vekrest-vekconsumer-modulo4.1.git

# Acesse a pasta do projeto
cd vekrest-vekconsumer-modulo4.1
````
...
docker build -t vekrest/vekconsumer:latest .

# Descomente as últimas linhas do docker-compose.yml (relacionadas ao vekconsumer) e rode:
docker-compose up -d
```
...
[![VekConsumer CI/CD Workflow](https://github.com/VekRest/vekrest-vekconsumer-modulo4.1/actions/workflows/main.yml/badge.svg)](https://github.com/VekRest/vekrest-vekconsumer-modulo4.1/actions/workflows/main.yml)
